...
# Copyright 2026 Luciano de Oliveira Nunes
# Vendored from lucianoon/llm-course via leanderdulac/curso-de-engenharia-de-IA
# See referencia/llm-course/LICENSE and NOTICE. Isolated from the UniPDS CC BY-NC-ND trunk.
