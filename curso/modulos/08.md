...
Opcional, **depois** dos protótipos TrialForge. Recorte Apache isolado — não misture com o código JS/Python desta pasta.

- RAG CPU (chunking, BM25, busca densa, RRF, hit@k / MRR): [`referencia/llm-course/modulo-13-rag/`](../../referencia/llm-course/modulo-13-rag/) — casa com 8.4 (gateway + RAG). A execução completa do lab pede os READMEs 01–12 do curso B; aqui o valor é o método e o `lab_cpu.py` como leitura.
- Serving / custo / disjuntor / eval-as-CI: [`referencia/llm-course/modulo-19-producao/`](../../referencia/llm-course/modulo-19-producao/) — casa com 8.5 (tiering, eval gate, observabilidade). Este lab **roda** no recorte (FAQ de brinquedo).
- Como usar e o que falta: [`referencia/llm-course/README.md`](../../referencia/llm-course/README.md). Crédito: [`curso/ATRIBUICOES-llm-course.md`](../ATRIBUICOES-llm-course.md).

Não entra na nota do M08 salvo o instrutor pedir um parágrafo no ADR ligando o padrão Python ao canvas.
